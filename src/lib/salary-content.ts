...
export function getAuthorBox(): { name: string; credentials: string; bio: string } {
  return {
    name: "Mottalib Radif MBA INSEAD",
    credentials: "MBA INSEAD | Especialista em Finan\u00e7as Pessoais e Fiscalidade",
    bio: "Mottalib Radif \u00e9 diplomado pelo MBA do INSEAD, uma das mais prestigiadas escolas de neg\u00f3cios do mundo, e possui experi\u00eancia em finan\u00e7as, consultoria e fiscalidade. Apaixonado por literacia financeira, criou o salarioliquido.pt para ajudar trabalhadores portugueses a compreenderem a sua folha de vencimento e a otimizarem a sua situa\u00e7\u00e3o fiscal.",
  };
}
